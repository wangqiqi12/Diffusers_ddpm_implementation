...
def parse_args():
    ...
    parser.add_argument("--adam_beta1", type=float, default=0.9, help="The beta1 parameter for the Adam optimizer.") # 修改！
...
def main(args):
    ...
    if args.use_ema:
        ema_model = EMAModel(
            ...
            use_ema_warmup=False, # 这里似乎是坑点，不能设置为True
    ...
    if accepts_prediction_type:
        ...
        noise_scheduler = DDPMScheduler(num_train_timesteps=args.ddpm_num_steps, beta_schedule=args.ddpm_beta_schedule,variance_type="fixed_large")
